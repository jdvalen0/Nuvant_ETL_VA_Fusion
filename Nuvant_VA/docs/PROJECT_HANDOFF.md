...
| **Deletion** | ⚠️ **BUG** | Endpoint exists but user reports UI/API failure deleting references. |
| **Defect Types** | 🚧 **WIP** | DB Schema updated, need to connect UI to `defect_types` API. |
