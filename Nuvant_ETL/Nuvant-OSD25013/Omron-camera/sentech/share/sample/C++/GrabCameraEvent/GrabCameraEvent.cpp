...
// If you want to use a class method as a callback function, please remove the comment mark.
...
//-----------------------------------------------------------------------------
void OnNodeCallbackCFunction(INode* pINode, UserParam_t pParam)
{
    OnNodeCallback(pINode, pParam);
}
