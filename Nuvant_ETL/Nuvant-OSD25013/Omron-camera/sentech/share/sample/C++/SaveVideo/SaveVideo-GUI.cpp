...
void acquisitionWorker(CIStDevicePtr *pIStDevice, CIStDataStreamPtr *pIStDataStream, CIStImageDisplayWndPtr *pIStImageDisplayWnd, CIStVideoFilerPtr *pIStVideoFiler, double fps, bool *isCompleted)
{
...
int main(int, char **)
{
    try
    {
        ...
        thread worker(acquisitionWorker, &pIStDevice, &pIStDataStream, &pIStImageDisplayWnd, &pIStVideoFiler, fps, &isCompleted);
