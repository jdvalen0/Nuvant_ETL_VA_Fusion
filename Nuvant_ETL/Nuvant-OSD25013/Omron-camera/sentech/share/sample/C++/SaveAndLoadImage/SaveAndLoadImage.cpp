...
int main(int, char **)
{
    try
    {
        ...
        GenICam::gcstring strFileNameHeader("/tmp");
        if (getenv("TMPDIR") != NULL)
            strFileNameHeader = GenICam::gcstring(getenv("TMPDIR"));
        ...
        if(pIStStreamBuffer->GetIStStreamBufferInfo()->IsImagePresent())
        {
            ...
            std::cout << std::endl << "Saving " << strFileNameRaw.c_str() << "... ";
        ...
        if (isImageSaved)
        {
            ...
            std::cout << std::endl << "Loading " << strFileNameRaw.c_str() << "... ";
            ...
            // Save as Bitmap
            {
                ...
                std::cout << std::endl << "Saving " << strImageFileName.c_str() << "... ";
