/*!
\file AllocateStreamBuffersManually-GUI.cpp
\brief 
...
{
        // A while loop to keep acquire data and check status. 
...
int main(int, char **)
{
    try
    {
        ...
        // Since GUI is used for display, create a display window here.
