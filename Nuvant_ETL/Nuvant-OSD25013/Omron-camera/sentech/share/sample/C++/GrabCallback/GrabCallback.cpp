...
// If you want to use the GUI features, please remove the comment and add linkage for StApi_GUI_qt.
...
#ifdef ENABLED_ST_GUI
#ifdef ENABLED_CLASS_METHOD_TYPE_CALLBACK
        CCallback objCStCallback;
        RegisterCallback(pIStDataStream, objCStCallback, &CCallback::OnStCallbackClassMethod, (UserParam_t)pIStImageDisplayWnd);
#else
