...
// If you want to use the GUI features, please remove the comment mark.
...
void UpdateDeviceIPAddress(GenApi::INodeMap *pINodeMap)
{
    ...
    for (;;)
    {
        ...
        // Displays the current subnet mask of the camera.
...
void UpdateHeartbeatTimeout(GenApi::INodeMap *pINodeMap)
{
    ...
    for (;;)
    {
        ...
        cout << endl << "Warning: the heartbeat sending interval is fixed when the device is initialized (opened)." << endl;
        ...
        cout << "or re-open the device after changing the heartbeat value without setting the environment variable and debugger." << endl << endl;
